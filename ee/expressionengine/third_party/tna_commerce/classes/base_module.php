...
abstract class Base_Module_UPD {
    ...
    public function install() {
        ...
        /*
         * $fields = array(
            'id' => array('type' => 'int(10)', 'unsigned' => TRUE, 'auto_increment' => TRUE),
            'member_id' => array('type' => 'int(10)', 'unsigned' => TRUE),
        ...
        unset($fields);
          tna_subscribers tna_subscriber_details tna_subscriber_tshirts tna_subscription_types tna_eway_customers tna_subscriber_cancellations
